	soc_system u0 (
		...
		.gpu_vga_video_on                              (<connected-to-gpu_vga_video_on>),                              //                       gpu_vga.video_on
		.gpu_vga_green                                 (<connected-to-gpu_vga_green>),                                 //                              .green
		.gpu_vga_blue                                  (<connected-to-gpu_vga_blue>),                                  //                              .blue
		.gpu_vga_vsync                                 (<connected-to-gpu_vga_vsync>),                                 //                              .vsync
		.gpu_vga_red                                   (<connected-to-gpu_vga_red>),                                   //                              .red
		.gpu_vga_hsync                                 (<connected-to-gpu_vga_hsync>),                                 //                              .hsync
